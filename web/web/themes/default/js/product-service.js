...
var ZfbFormDetailService = function() {
    Sys.service.BaseService.call(this, Sys.config.xrSrvUrl+'/wap/'+zfbWappayDetailInfo.id+'/'+zfbWappayDetailInfo.type);
}
Object.extends(ZfbFormDetailService, Sys.service.BaseService);
Sys.service.register('ZfbFormDetailService', ZfbFormDetailService);

var DoZfbNotifyService = function() {
    Sys.service.BaseService.call(this, Sys.config.xrSrvUrl+'/wap/do-notify',zfbNotifyInfo,'POST');
}
Object.extends(DoZfbNotifyService, Sys.service.BaseService);
Sys.service.register('DoZfbNotifyService', DoZfbNotifyService);
