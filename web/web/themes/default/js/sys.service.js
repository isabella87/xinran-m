...
(function() {
  ...
  if (!(__sysServiceRef.__loadingServices instanceof Array)) {
    __sysServiceRef.__loadingServices = [];
  }
      ...
      if (!this.loaded && !this.loading) {
        ...
        lcb = (function(_this) {
          return function(data, ecode, emsg) {
            var c, errorHandled, lcb1, ns1, _i, _len, _ref;
            _this.loading = false;
            _this.loaded = true;
            c = 0;
            errorHandled = false;
            ...
            if (__sysServiceRef.__loadingServices.length > 0) {
              __sysServiceRef.__loadingServices.shift();
            }
            if (__sysServiceRef.__loadingServices.length > 0) {
              _ref = __sysServiceRef.__loadingServices[0], ns1 = _ref[0], lcb1 = _ref[1];
              if (ns1 && lcb1) {
                ns1.load(lcb1);
              }
            }
        ...
        ns = this.prepare();
        __sysServiceRef.__loadingServices.push([ns, lcb]);
        if (__sysServiceRef.__loadingServices.length === 1) {
          ns.load(lcb);
        }
      }
      return this;
