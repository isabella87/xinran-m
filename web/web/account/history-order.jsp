...
<body>
	    ...
	    <div class="bm_wrapper" id="label_switch">
		      <div class="bm_less_head_tab">
		        <ul class="ban_product_class_ul">
		          <li class="ban_pc_li_chosse"><a href="javascript:void(0);" class="ban_pc_a">历史订单</a></li>
		          <li class="ban_pc_li"><a href="../account/order.html" class="ban_pc_a">待支付订单</a></li>
		        </ul>
	...
	<script type="text/javascript">
	   'use stricts';
		...
		var g_pageIndex = 1;
		var pageCount = 0;
		var orderInfo = {status : '65535', pn : g_pageIndex , 'pay-type' : 65535};
		...
		Sys.service.on('OrderService',function(data){
			if(data.items){
				...
				$.each(data.items,function(i,d){
					...
					html.push('      <li class="ban_shouyi_box ban_shouyi_box2"><span class="ban_sy_span"><em class="ban_sy_num ban_sy_num2">'+payTypeDesc +'</em></span><span class="ban_sy_span2">支付方式</span></li> ');
					html.push('  </ul> ');
					html.push('</div>');
				});
