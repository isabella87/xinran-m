...
<body>
	    ...
	    <div class="bm_wrapper" id="label_switch">
		      <div class="bm_less_head_tab">
		        <ul class="ban_product_class_ul">
		          <li class="ban_pc_li"><a href="../account/history-service.html" class="ban_pc_a">历史服务</a></li>
		          <li class="ban_pc_li_chosse"><a href="javascript:void(0);" class="ban_pc_a">待支付服务</a></li>
		        </ul>
	...
	<script type="text/javascript">
	   'use stricts';
		...
		var g_pageIndex = 1;
		var pageCount = 0;
		var serviceInfo = {status : '1', pn : g_pageIndex};
		...
		Sys.service.on('MajorServiceService',function(data){
			if(data.items){
				...
				$.each(data.items,function(i,d){
					...
					html.push('          <div class="ban_case_class ban_gong_color">支</div>  ');
					...
					html.push(' 	 <li class="ban_shouyi_box ban_shouyi_box3"><a href="../pay/pay-serving.html?id='+d.msId +'" class="ban_tz_btn ban_tz_color">立即支付</a></li> '); 
					html.push('  </ul> ');
					html.push('</div>');
				});
