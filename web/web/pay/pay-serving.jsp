...
<body>
	...
	<script type="text/javascript">
	   ...
	   function showServiceDetails(){
			...
			html.push('<span style="color:red;font-size:36px">'+Sys.formatNumber(d.fee, true, 2)+'</span>元<br/>');
			html.push('<span>');
			html.push(d.serviceName+'</span></p>');
			...
			buttomHtml.push('确认支付￥'+Sys.formatNumber(d.fee, true, 2)+'元</a>');
	   ...
	   function submitPay(){
		   if(!document.getElementById("check1").checked){
			   Sys.infoDlg("请选择支付方式！");
				...
				window.location.assign(Sys.evalUrl("/pay/to-pay.html?type=1&id="+msId));
